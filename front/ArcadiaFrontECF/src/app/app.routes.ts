    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {path: 'animals/detailed/:id', component: AdminAnimalsFormComponent , canActivate: [adminGuard]},
          {path: 'animals/new', component: AdminAnimalsFormComponent, pathMatch: "full" , canActivate: [adminGuard]},
          ...
          {path: 'species/detailed/:id', component: AdminSpeciesFormComponent , canActivate: [adminGuard]},
          {path: 'species/new', component: AdminSpeciesFormComponent, pathMatch: "full" , canActivate: [adminGuard]},
          {path: 'habitats', component: AdminHabitatsListComponent , canActivate: [authGuard]},
          {path: 'habitats/detailed/:id', component: AdminHabitatsFormComponent , canActivate: [adminGuard]},
          {path: 'habitats/new', component: AdminHabitatsFormComponent, pathMatch: "full" , canActivate: [adminGuard]},
          ...
          {path: 'services/new', component: AdminServicesFormComponent, pathMatch: "full" , canActivate: [adminGuard]},
          {path: 'opening-hours', component: AdminOpeningHoursManagementComponent , canActivate: [adminGuard]},
          {path: 'opening-hours/:id', component: AdminOpeningHoursFormComponent, pathMatch: "full" , canActivate: [adminGuard]},
        ]
      },
